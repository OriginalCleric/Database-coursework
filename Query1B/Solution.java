...
public class Solution {
        ...
        */
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException
        {
           // System.out.println(value.toString());
            ...
            if ( row.length < 21 
            || row[0].length()==0
            || Integer.parseInt(row[0]) < startDate 
            || Integer.parseInt(row[0]) > endDate)
            {
            ...
            context.write(new Text(row[2]), new IntWritable(num));
    ...
    public static class MyReducer extends Reducer<Text,IntWritable,Text,IntWritable> {
        ...
        public PriorityQueue<Map.Entry<CompositeKey<Integer,String>,Integer>> myQueue;
        private int K;
                                        ...
                                        InterruptedException
        {
           // this.myQueue = new PriorityQueue<Map.Entry<Integer,Text>>(Map.Entry.comparingByKey(Comparator.reverseOrder()));
            this.myQueue = new PriorityQueue<Map.Entry<CompositeKey<Integer,String>,Integer>>(Map.Entry.comparingByKey());
        ...
        public void reduce(Text key, Iterable<IntWritable> values,Context context) throws IOException, InterruptedException {
            ...
            CompositeKey<Integer,String> newKey = new CompositeKey<Integer,String>(sum,key.toString());
            if (myQueue.size() >= K)
            {
            ...
            myQueue.add(new AbstractMap.SimpleEntry<CompositeKey<Integer,String> ,Integer>(newKey,1));
                                           ...
                                           InterruptedException
        {
            ...
            for (int i=0;i<max;i++)
            {
                Map.Entry<CompositeKey<Integer,String> ,Integer> current = myQueue.poll();
                context.write(new Text(current.getKey().key2), new IntWritable(current.getKey().key1));
            }
        }
    }
    ...
    public static class SortMapper extends Mapper<Object, Text, Text, IntWritable>{
        ...
        public void setup(Context context) throws IOException,
                                        InterruptedException
        {
            this.myQueue = new PriorityQueue<Map.Entry<CompositeKey<Integer,String> ,Integer>>(Map.Entry.comparingByKey(Comparator.reverseOrder()));
            this.K = Integer.parseInt(context.getConfiguration().get("K"));
        }
        ...
        */
        public void map(Object key, Text value, Context context) throws IOException, InterruptedException {
          // String id = key.toString();
            ...
            CompositeKey<Integer,String> newKey = new CompositeKey<Integer,String>(numSold,row[0]);
    ...
    public static class SortReducer extends Reducer<Text,IntWritable,Text,IntWritable> {
        ...
        public void reduce(Text key, Iterable<IntWritable> values,Context context) throws IOException, InterruptedException {
            ...
            int numSold = 0;
            CompositeKey<Integer,String> newKey = new CompositeKey<Integer,String>(numSold,key.toString());
           for(IntWritable val:values)
           {
                numSold = val.get();
                if (myQueue.size() >= K)
